class MeteoConstants:
    __DATA = [
        ...
        ("air_temp_5cm_above_ground_avg_1m", "Air temperature 5 cm above ground (1 minute average)", "°C", False),
        ("air_temp_surface_avg_1m", "Air temperature at ground surface (1 minute average)", "°C", False),
        ("ground_temp_5cm_avg_1m", "Ground temperature 5 cm under surface (1 minute average)", "°C", False),
        ("ground_temp_10cm_avg_1m", "Ground temperature 10 cm under surface (1 minute average)", "°C", False),
        ("ground_temp_20cm_avg_1m", "Ground temperature 20 cm under surface (1 minute average)", "°C", False),
        ("ground_temp_50cm_avg_1m", "Ground temperature 50 cm under surface (1 minute average)", "°C", False),
        ("ground_temp_100cm_avg_1m", "Ground temperature 100 cm under surface (1 minute average)", "°C", False),
        ("wind_direction_inst", "Wind direction (instant)", "°", False),
        ("wind_speed_inst", "Wind speed (instant)", "m/s", True),
        ...
        ("pressure_adj_avg_1m", "Atmospheric pressure reduced to sea level (1 minute average)", "hPa", True),
